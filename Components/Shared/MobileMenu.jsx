...
const ItemStyle =
  "flex items-center justify-between w-full  lg:text-base xl:text-base 2xl:text-xl text-black rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 md:w-auto lg:ml-6 ";
