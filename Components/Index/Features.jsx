...
const div = 'lg:mr-10  sm:mr-24  lg:w-full lg:h-auto sm:w-4/5 sm:mx-auto md:w-2/3 max-width-screen-xl  relative grid lg:grid-cols-6 md:grid-cols-2 gap-2 aspect-square mx-auto '
