            ...
            <div
                ...
                <div className='xl:mt-6'>
                    <h1 className='font-rubik md:text-xl text-gray-700 lg:mt-12 md:mt-6 sm:mt-6  text-lg font-bold sm:mt-48 sm:text-center sm:text-xl'>
                        <span className="pb-2 border-gray-700 border-b">{supertitle}
                        </span>
                    </h1>
                    <div
                        className=" 
                    font-nunito
                text-blue-900 text-center lg:text-start  lg:text-4xl sm:text-3xl  font-bold lg:leading-[4rem]  sm:leading-[4rem] sm:leading-[2rem] lg:mt-6 md:mt-6 xs:pt-56 lg:mx-0 sm:mt-4 sm:ml-10 sm:mr-10 xs:text-3xl xs:mt-56 md:text-4xl " >{title}
