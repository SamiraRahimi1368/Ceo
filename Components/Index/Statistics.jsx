...
const div3='text-white text-2xl font-semibold camelcase tracking-wide mt-2 font-nunito'
const Statistics = () => {
  ...
  return (
    <div className="max-w-screen-lg mx-auto rounded-lg  h-48 bg-blue-400 flex justify-center items-center mb-4 mt-12 font-nunito"
    style={{
      ...
      <div className={div1}>
        <div className={div2}>
          <span className="mr-2">+</span>
          <CountUp start={0} end={globalPresence} duration={2.5} separator="," />
        </div>
