...
const Hero = () => {
    ...
    return <div
        className="hero flex flex-col items-center -mt-24 z-10"
        ...
        <div className=" w-full h-auto px-4 lg:grid lg:grid-cols-2 lg:items-top lg:gap-12 lg:px-12 xl:px-20 max-w-screen-xl xl:mx-auto lg:mx-auto">
            ...
            <div className="lg:mr-10 xl:mt-44 sm:mr-24  mt-16 sm:w-4/5 sm:mx-auto md:w-2/3 max-width-screen-lg  relative grid lg:grid-cols-6 md:grid-cols-12 gap-4 aspect-square">
