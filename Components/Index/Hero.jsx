...
const Hero = () => {
    return <div
        ...
        <div className=" w-full h-full px-4 lg:grid lg:grid-cols-2 lg:items-top lg:gap-12 lg:px-12 xl:px-20 max-w-screen-xl xl:mx-auto lg:mx-auto">
            <div>
                <h1 className="text-white font-medium mt-28	">Welcome To Sceo
                </h1>
                <div className=" font-dosis text-slate-100 text-center lg:text-start  lg:text-5xl sm:text-3xl  font-bold lg:leading-[4rem]  sm:leading-[4rem] sm:leading-[2rem] lg:mt-12 md:mt-48  lg:mx-0 sm:mt-36 sm:ml-10 sm:mr-10 xs:text-3xl xs:mt-48">We Provide SEO Services For Agency</div>
            ...
            />
                ...
                <Image
                    fill
                    className=" object-cover z-1 max-w-fit lg:ml-48 "
                    src='/images/2.png'
                    alt="home-font"
                />
            ...
            <Image
                ...
                fill
                src='/images/8.png'
                className="w-min lg:mt-0	lg:ml-96"
            ...
            />
                ...
                <Image
                    ...
                    fill
                    src='/images/3.png'
                    className="max-w-fit lg:-ml-48 mt-16"
